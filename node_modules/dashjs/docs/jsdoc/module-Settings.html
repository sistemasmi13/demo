		...
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-37">line 37</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type"><a href="module-Settings.html#~AudioVideoSettings">module:Settings~AudioVideoSettings</a></span>
            ...
            <td class="description last"><p>The maximum bitrate that the ABR algorithms will choose.</p>
<p>Use NaN for no limit.</p></td>
        </tr>
...
<span class="param-type"><a href="module-Settings.html#~AudioVideoSettings">module:Settings~AudioVideoSettings</a></span>
            ...
            <td class="description last"><p>The minimum bitrate that the ABR algorithms will choose.</p>
<p>Use NaN for no limit.</p></td>
        </tr>
...
<span class="param-type"><a href="module-Settings.html#~AudioVideoSettings">module:Settings~AudioVideoSettings</a></span>
            ...
            <td class="description last"><p>Explicitly set the starting bitrate for audio or video.</p></td>
        </tr>
...
<span class="param-type">string</span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-305">line 305</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">boolean</span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-244">line 244</a>
			</li>
		</ul>
	</dd>
...
<p>A value defined in milliseconds representing how log to cache the settings for.</p></td>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-354">line 354</a>
			</li>
		</ul>
	</dd>
...
<p>If not specified this value defaults to 'query'.</p></td>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-614">line 614</a>
			</li>
		</ul>
	</dd>
...
<p>Note this will be dispatched regardless of log level.</p></td>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-313">line 313</a>
			</li>
		</ul>
	</dd>
...
<p>For mediaErrorDecode the player will reset the MSE and skip the blacklisted segment that caused the decode error. The resulting gap will be handled by the GapController.</p></td>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-346">line 346</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">boolean</span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-364">line 364</a>
			</li>
		</ul>
	</dd>
...
<table class="props table table-striped">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>minDrift</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>Use this method to set the minimum latency deviation allowed before activating catch-up mechanism.</p>
<p>In low latency mode, when the difference between the measured latency and the target one, as an absolute number, is higher than the one sets with this method, then dash.js increases/decreases playback rate until target latency is reached.</p>
<p>LowLatencyMinDrift should be provided in seconds, and it uses values between 0.0 and 0.5.</p>
...
<p>If no value is specified this will be twice the maximum live delay.</p>
<p>The maximum live delay is either specified in the manifest as part of a ServiceDescriptor or calculated the following:<br>
maximumLiveDelay = targetDelay + liveCatchupMinDrift.</p></td>
        </tr>
...
<p>Note: Catch-up mechanism is automatically applied when playing low latency live streams.</p></td>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-435">line 435</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Set to true if dash.js should use latency targets defined in ServiceDescription elements</p></td>
        </tr>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-222">line 222</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type"><a href="module-Settings.html#~StreamingSettings">module:Settings~StreamingSettings</a></span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-43">line 43</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">boolean</span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-520">line 520</a>
			</li>
		</ul>
	</dd>
...
<p>Note: It's not type of request.</p></td>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-492">line 492</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">boolean</span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-419">line 419</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">number</span>
        ...
        <tr>
                ...
                <td class="name"><code>lowLatencyEnabled</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Manually enable or disable low latency mode.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>lowLatencyEnabledByManifest</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>If this value is set to true we enable the low latency mode based on MPD attributes:  Specifically in case &quot;availabilityTimeComplete&quot; of the current representation is set to false.</p></td>
        </tr>
...
<span class="param-type">number</span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-429">line 429</a>
			</li>
		</ul>
	</dd>
...
In case the MPD uses &lt;SegmentTimeline\ and no segment is found within the DVR window the DVR window is calculated based on the entries in &lt;SegmentTimeline&gt;.</li>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-214">line 214</a>
			</li>
		</ul>
	</dd>
